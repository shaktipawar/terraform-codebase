...
# variable "key_name" {
#   type        = string
#   description = "Name of the key pair for SSH access to EC2 instances."
# }

# variable "instance_profile_name" {
#   type        = string
#   description = "Configuration for the IAM instance profile including name, path, role, and tags."
# }
...
# variable "iam_policy" {
#   type = object({
#     cloudwatch_role_name              = string
#     cloudwatch_log_policy_name        = string
#     cloudwatch_log_policy_description = string
#   })
#   description = "IAM role and policy configuration for CloudWatch logging."
# }

# variable "cloudwatch_logs" {
#   type = object({
#     cloudwatch_log_group_name           = string
#     cloudwatch_log_group_retention_days = string
#   })
#   description = "IAM policy configuration including name, description, and policy document."
# }